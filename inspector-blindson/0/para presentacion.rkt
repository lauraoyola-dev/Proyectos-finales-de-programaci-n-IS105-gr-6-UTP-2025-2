...
(define (dibujar-plataforma p escena)
  (place-image (rectangle (third p) (fourth p) "outline" "transparent")
               (+ (first p) (/ (third p) 2))
               (+ (second p) (/ (fourth p) 2))
               escena))

(define (dibujar-escalera e escena)
  (place-image (rectangle (third e) (fourth e) "outline" "transparent")
               (+ (first e) (/ (third e) 2))
               (+ (second e) (/ (fourth e) 2))
               escena))

(define (dibujar-puerta escena)
  (place-image (rectangle puerta-ancho puerta-alto "outline" "transparent")
